...
export default class EditExercises extends Component{
    ...
    // display user from database on the dropdown
    componentDidMount(){
    ...
    componentDidMount(){
     ...
     //methods for changing the state of properties
    onChangeUsername(e){
         this.setState({
    ...
    //method that handles the submit button
    onSubmit(e){
        e.preventDefault()
        ...
        // sends http post request to backend endpoint
